...
ui <- dashboardPage(skin="black",
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Controles", tabName="dashboard2",icon=icon("cogs"), 
               selectInput("empresas", h5("Seleccione una empresa:"), 
                           choices = list("Elektra" = 1, "Cemex" = 2,
                                          "Alsea" = 3), selected = 1),
               selectInput("tipoprecio", h5("Seleccione un tipo de precio:"), 
                           choices = list("Cierre" = 1, "Apertura" = 2), selected = 1),
               
               checkboxInput("tendencia", "Ver tendencia", value = FALSE),
               radioButtons("radio", h5("Radio buttons"),
      ...
      tabItem(tabName = "dashboard1",
        fluidRow(
          ...
          box(h5("Resultado:"),
              ...
              plotOutput(outputId = "historico"), solidHeader = FALSE, height="auto", width = "100%")
          )
        )
      )
